        ...
        <>
            ...
            <CustomGridLayout>
                <CustomCard title="General Details" height="200px">
                    ...
                    <CustomListItem data={data} label="Allow Multi-Club Clock In/Out" name="multiClubInOut" />
                    <CustomListItem data={data} label="Clock In Department Required" name="clockInRequired" />
                </CustomCard>
