...
export default function DashboardGraphs() {
    ...
    const NewRegistration = {
        ...
        options: {
            ...
            xaxis: {
                categories: [['jan'], [''], ['March'], [''], ['May'], [''], ['July'], [''], ['Sep'], [''], ['Nov'], [''], ['Jan'], [''], ['March']],
                labels: {
                    style: {
                        // colors: colors,
                        fontSize: '12px',
    ...
    return (
        <div className="grid my-2">
            ...
            <Graphcard title="Members Status by Month">
                <ReactApexChart options={MemberStatus.options} series={MemberStatus.series} type="donut" height={350} />
            </Graphcard>
            <Graphcard title="Revenue & Active Members Trend">
                <ReactApexChart options={RevenueActiveMembers.options} series={RevenueActiveMembers.series} type="line" height={350} />
            </Graphcard>
            <Graphcard title="New Registration by Month">
                <ReactApexChart options={NewRegistration.options} series={NewRegistration.series} type="bar" height={350} />
            </Graphcard>
        </div>
    );
}
