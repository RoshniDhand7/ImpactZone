  ...
  return (
    <>
      {showAddCompanyDetails ? (
        ...
        <>
          <div className="">
            <div className="flex justify-content-end mx-3 mt-3">
              <Buttons
                onClick={onClickDivChange}
            ...
            <div className="flex ">
              <div className="col mt-3">
                <CardWithTitle title="Booking Information  ">
                  <div className="card-height flex justify-content-between p-3">
                    <div className="font-semibold text-sm flex flex-column justify-content-between ">
                      <span>Book Out from</span>
                      <span>Book Out to</span>
                    </div>
                    <div className="flex flex-column justify-content-between"></div>
                  </div>
                </CardWithTitle>
              ...
              <div className="col mt-3">
                <CardWithTitle title="Cancellation Information">
                  <div className="card-height flex justify-content-between p-3">
                    <div className="font-semibold text-sm flex flex-column justify-content-between">
                      <span>Allow Cancel Online</span>
