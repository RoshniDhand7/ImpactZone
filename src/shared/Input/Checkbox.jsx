...
const Checkbox = ({ label, className, value, onChange, name, data, id = 'defaultId' }) => {
    return (
        <div className="form-check border-gray-100 custome-checkbox ">
            <input
                ...
                id={id}
            />
            <label className={`text-xs text-dark-gray flex justify-content-between font-semibold ${className}`} htmlFor={id}>
                <span className="mr-2">
